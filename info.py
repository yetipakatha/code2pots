...
BOT_USERNAME = environ.get("BOT_USERNAME", "@testingggsz_bot")
BOT_NAME = environ.get("BOT_NAME", "testings")
BOT_ID = environ.get("BOT_ID", "7010331289")
S_GROUP = environ.get('S_GROUP', "universe_we_are")
S_CHANNEL = environ.get('S_CHANNEL', "we_are_universee")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/SVDmaniamovies')
