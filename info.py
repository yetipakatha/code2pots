...
BOT_TOKEN = environ.get('BOT_TOKEN', "7531195776:AAFzn6oX5mWU46DK-vWfa7GcqF6k5K8Ulps")
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002192455941"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002192455941') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002237503909') # request channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "Muzi_tes_bot")
BOT_NAME = environ.get("BOT_NAME", "Testie")
BOT_ID = environ.get("BOT_ID", "7531195776")
